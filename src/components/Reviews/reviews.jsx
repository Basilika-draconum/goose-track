...
export const Reviews = () => {
  ...
  return (
      ...
      <h2 className={css.reviewsTitle}>reviews</h2>
          <div className={css.wrapperReviewConteiner}>
        {reviews
          .slice(
            currentReview,
          ...
          .map(review => (
              <div className={css.reviewContainer} key={review.id}>
                  <div className={css.flexConteiner}>
                <img className={css.avatar} src={review.avatar} alt={review.name} />
        ...
        <button className={css.buttons} onClick={prevReview}>
          <ArrowLeft />
        </button>
        <button className={css.buttons} onClick={nextReview}>
          <ArrowRight />
        </button>
      </div>
    </div>
